    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-8">
      <div className={`w-full max-w-md transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        ...
        <div className="text-center mb-12">
          <LogIn className="mx-auto mb-6" size={48} strokeWidth={3} />
          <h1 className="text-5xl sm:text-6xl font-black text-black leading-none mb-2">welcome</h1>
          <h2 className="text-5xl sm:text-6xl font-black text-black leading-none">back</h2>
        </div>
        ...
        <div className="mt-8 text-center">
          ...
          <button onClick={() => router.push("/signup")} className="text-black font-black text-lg hover:underline">
            Sign Up
          </button>
        </div>
